  ...
  const serviceRates = [
    {
      ...
      features: ['Consultation', 'Basic service', 'Follow-up'],
    },
    {
      ...
      features: ['Extended consultation', 'Premium service', 'Aftercare', 'Product recommendations'],
      popular: true,
    },
    {
      name: 'Deluxe Package',
      ...
      features: ['Full consultation', 'Deluxe service', 'Premium products', 'Extended aftercare'],
    },
  ]
      ...
      <section className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              We accept all major credit cards, PayPal, and regional payment methods like TWINT (Switzerland) and SEPA (EU).
            </p>
          </div>
