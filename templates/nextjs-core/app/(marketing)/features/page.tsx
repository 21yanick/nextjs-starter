...
import { getAvailableFeatures } from '@/lib/business-config'
import { 
  Shield, 
  Zap, 
  Users, 
...
export default function FeaturesPage() {
  ...
  const coreFeatures = [
    ...
    },
    {
      ...
      description: 'Speziell für den Schweizer Markt entwickelt mit lokalen Standards.',
      features: ['CHF Währung', 'TWINT Integration', 'CH-Compliance', 'MwSt 7.7%'],
    },
  ]
  ...
  const shopFeatures = [
    ...
    {
      icon: CreditCard,
      title: 'Swiss Payment Processing',
      description: 'Sichere Zahlungsabwicklung mit Schweizer Payment-Methoden.',
      features: ['Kreditkarten', 'TWINT', 'PostFinance', 'CHF-optimiert'],
    },
    {
      icon: BarChart3,
